...
class ProductController extends Controller
{
    ...
    {
        $data['product'] = ProductModel::where('user_id', auth()->user()->id)->get();
    ...
    {   
        ...
        if ($cek) {
            return redirect(route('seller.product.index'))->with('error', 'Product already exist !');            
        }else{
            ...
            return redirect(route('seller.product.index'))->with('message', 'Product success Added !');
        }        
    }
